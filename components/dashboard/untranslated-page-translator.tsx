...
const EXACT: Record<string, string> = {
  ...
  "تم إنشاء حساب الموظف بدون إرسال أي بريد. عيّن له كلمة مرور مؤقتة من الجدول أدناه.": "The employee account was created without sending any email. Set a temporary password from the table below.",
  "تعذر إنشاء حساب الموظف في Supabase.": "The employee account could not be created in Supabase.",
  "تم إلغاء إنشاء الحساب لأن ملف الموظف لم يكتمل.": "Account creation was rolled back because the employee profile was not completed.",
  "فعّلي المستخدم أولًا.": "Activate the user first.",
  "بانتظار كلمة مؤقتة": "Awaiting temporary password",
  "دخول مؤقت": "Temporary access",
  "لم تُعيّن بعد": "Not set yet",
  "مؤقتة — يجب تغييرها": "Temporary — must be changed",
  "كلمة شخصية": "Personal password",
